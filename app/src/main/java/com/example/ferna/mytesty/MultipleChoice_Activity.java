...
public class MultipleChoice_Activity extends AppCompatActivity {
    ...
    private void init(){
        ...
        saveButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                newQuiz.addQuest(0, qstTxt.getEditText().getText().toString(), corAns.getEditText().getText().toString(), incAns1.getEditText().getText().toString(),
                                    incAns2.getEditText().getText().toString(), incAns3.getEditText().getText().toString(), null);
